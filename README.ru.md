...
- **Диск.** Изоляция полная, поэтому каждый профиль заново скачивает тяжёлую часть — образы песочницы и кэши, это несколько ГБ на профиль. В этой версии ничего не разделяется.
