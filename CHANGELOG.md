...
* carry the standard account's token through import ([#131](https://github.com/Nemo-Illusionist/claude-code-account-switcher/issues/131)) ([ca21fff](https://github.com/Nemo-Illusionist/claude-code-account-switcher/commit/ca21fff2ed1471e457d8deb93125278c7068a8ab))
* find the standard account's token in the unscoped keychain entry ([#130](https://github.com/Nemo-Illusionist/claude-code-account-switcher/issues/130)) ([eb65837](https://github.com/Nemo-Illusionist/claude-code-account-switcher/commit/eb6583722d22649c419dcf6de0768f99e393fd57))
